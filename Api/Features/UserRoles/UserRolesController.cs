...
public class UserRolesController(IUserRoleService _userRoleService) : CustomBaseController
{
  ...
  [HttpPost]
  public async Task<IActionResult> Assign([FromBody] CreateUserRoleRequest request, CancellationToken cancellationToken)
  {
  ...
  public async Task<IActionResult> Sync([FromRoute] Guid userId, [FromBody] List<Guid> roleIds, CancellationToken cancellationToken)
  {
